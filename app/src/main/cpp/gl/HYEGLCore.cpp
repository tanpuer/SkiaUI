...
int
HYEGLCore::createGLEnv(EGLContext sharedCtx, ANativeWindow *nativeWindow, int width, int height,
                       bool offScreen) {
...
EGLSurface HYEGLCore::getEGLSurface() {
    return mEGLSurface;
}

EGLContext HYEGLCore::getEGLContext() {
    return mEGLCtx;
}

EGLDisplay HYEGLCore::getEGLDisplay() {
    return mEGLDisplay;
}

void HYEGLCore::swapBuffer() {
    if (mEGLDisplay != EGL_NO_DISPLAY && mEGLSurface != EGL_NO_SURFACE) {
        eglSwapBuffers(mEGLDisplay, mEGLSurface);
    }
}

void HYEGLCore::makeCurrent() {
